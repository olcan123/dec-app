...
const { inputId, step } = toRefs(props);

const { value, errorMessage } = useField(inputId.value);


// Computed property to handle number input as string 
// Burada amac , number input'un boş bırakılması durumunda veya sayi girilmesi durumunda da doğru şekilde vee-validate ile senkronize olmasını sağlamak.
